...
namespace ProjectAkhirPAW.Controllers
{
    public class PelayansController : Controller
    {
        ...
        public PelayansController(cafetariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPelayan,Nama,Alamat,Password,JenisKelamin")] Pelayan pelayan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPelayan,Nama,Alamat,Password,JenisKelamin")] Pelayan pelayan)
        {
