...
namespace ProjectAkhirPAW.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ManagersController(cafetariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdManager,Nama,Alamat,Password,JenisKelamin")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdManager,Nama,Alamat,Password,JenisKelamin")] Manager manager)
        {
